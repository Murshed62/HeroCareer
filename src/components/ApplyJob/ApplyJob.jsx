...
import { getLocalData, getShoppingCart } from "../../utilities/fakedb";
...
const handleJob=(e)=>{
  ...
  const showDatas=applyJobs.filter(dt=>dt.jobCategoryTimes ==remoteData)
  ...
  return (
    <div>
        <h1 className="text-5xl mt-40 mb-20  font-bold text-center">Applied Jobs</h1>
